-- DELIVERIES & RETURNS FRANCHISE ISOLATION
-- This script ensures franchise admins only see their own deliveries and returns

-- ============================================================================
-- PART 1: DELIVERIES TABLE
-- ============================================================================
...
SELECT 
    ...
    cmd
FROM pg_policies
WHERE tablename IN ('deliveries', 'returns', 'return_items')
...
WHERE table_name IN ('deliveries', 'returns')
AND column_name = 'franchise_id'
ORDER BY table_name;

-- Expected result: 2 rows (deliveries and returns)

SELECT '✅ DELIVERIES & RETURNS ARE NOW FULLY FRANCHISE-ISOLATED' AS status;
