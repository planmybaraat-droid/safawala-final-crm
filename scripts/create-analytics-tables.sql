...
DROP TABLE IF EXISTS expense_analysis CASCADE;
...
BEGIN
    ...
    -- Mumbai Central - 6 months of data
    ...
    -- Bangalore South - 6 months of data
    ...
    (franchise1_id, 'INSURANCE', 12500, 'Business insurance premium', '2024-07-30', admin_user_id),
    ...
    (franchise2_id, 'MISCELLANEOUS', 3400, 'Other business expenses', '2024-07-30', admin_user_id),
    ...
    (franchise3_id, 'INSURANCE', 10700, 'Business insurance', '2024-07-30', admin_user_id);
