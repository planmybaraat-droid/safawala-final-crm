...
-- Creates tables if they don't exist, then adds missing columns
...
-- 2. Create branding_settings table
...
-- 3. Create banking_details table
...
CREATE INDEX IF NOT EXISTS idx_company_settings_franchise 
ON company_settings(franchise_id);

CREATE INDEX IF NOT EXISTS idx_branding_settings_franchise 
ON branding_settings(franchise_id);

CREATE INDEX IF NOT EXISTS idx_banking_details_franchise 
ON banking_details(franchise_id);

CREATE INDEX IF NOT EXISTS idx_banking_details_primary 
ON banking_details(franchise_id, is_primary) 
