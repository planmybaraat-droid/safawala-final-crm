...
DO $$
BEGIN
    RAISE NOTICE 'Settings tables setup completed successfully!';
    RAISE NOTICE 'Created tables: company_settings, user_settings, notification_settings, business_hours, tax_settings, payment_gateway_settings, system_settings, integration_settings';
END $$;
