...
export const PORTAL_CONFIG: Record<DepartmentSlug, PortalConfig> = {
  ...
  warehouse: {
    ...
    tabs: [
      ...
      { icon: "box", label: "Inventory", href: "/portal/warehouse/inventory", permission: "warehouse.update" },
      { icon: "package", label: "Packages", href: "/portal/warehouse/packages", permission: "warehouse.view" },
