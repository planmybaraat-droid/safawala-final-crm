...
export default function TravelsAssignmentsPage() {
  ...
  return (
    <div style={{ fontFamily: "'Inter','Segoe UI',sans-serif", minHeight: "100vh", background: "#f5ebe0" }}>
      <PortalPageHeader title="Event Assignments" subtitle="Assign stylists · track travel status" color={COLOR} backHref="/portal/fulfillment/travel" />
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ padding: "0 20px" }}>
              ...
              <a href={`/portal/fulfillment/travel/tickets?id=${sheet.event.id}`} style={{
